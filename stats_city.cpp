...
class stats_city {
    ...
    //where it says randFloat = 0, replace with whatever the random function is
    public:
        char* choose_building_residential() {
